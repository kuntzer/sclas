...
demo = sclas.SClas('demo_multipsf_gmm')
...
#===================================================================================================
encoder_params = {'n_components':20}
encoder_method = sclas.encoder.ICA(encoder_params)

#===================================================================================================
# Classifier definition and parameters
#===================================================================================================
classifier_params = {'n_components': 14,
					'features': range(encoder_params['n_components']), 
					'labels': range(1)}
classifier_method = sclas.classifier.GaussianMixtureModel(classifier_params)
